...
ApiRoute::group(['namespace' => 'App\Http\Controllers\Api'], function () {
    ...
    ApiRoute::get('period-api-data-import-session/{period_id}', ['as' => 'api.period-api-data-import-session.index', 'uses' => 'ApiDataImportController@index']);
    ApiRoute::get('process-session-import-data', ['as' => 'api.process-session-import-data.processImportedData', 'uses' => 'ApiDataImportController@processImportedData']);
    ApiRoute::get('total-member', ['as' => 'api.total-member.totalMember', 'uses' => 'ApiDataImportController@totalMember']);
    ApiRoute::get('member-checking', ['as' => 'api.member-checking.memberChecking', 'uses' => 'ApiDataImportController@memberChecking']);
    ApiRoute::get('allocation-user-search', ['as' => 'api.allocation-user-search.AllocationUserSearch', 'uses' => 'CustomizeController@AllocationUserSearch']);
