...
<!--                        <a-descriptions-item :label="$t('user.phone')">-->
                        <a-descriptions-item label="NRC Number">
                            {{ user.phone ? user.phone : "-" }}
                        </a-descriptions-item>
<!--                        <a-descriptions-item-->
<!--                            v-if="user.user_type != 'staff_members'"-->
<!--                            :label="$t('user.tax_number')"-->
<!--                        >-->
<!--                            {{ user.tax_number ? user.tax_number : "-" }}-->
<!--                        </a-descriptions-item>-->
                        <a-descriptions-item
...
<!--                        >-->
<!--                            <UserBalance-->
<!--                                v-if="user.details && user.details.due_amount"-->
<!--                                :amount="user.details.due_amount"-->
<!--                            />-->
<!--                        </a-descriptions-item>-->
<!--                        <a-descriptions-item-->
<!--                            v-if="user.user_type != 'staff_members'"-->
